...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @wordpress/element */ "./node_modules/@wordpress/element/node_modules/react/index.js");
...
var pure = (0,_utils_create_higher_order_component__WEBPACK_IMPORTED_MODULE_5__.default)(function (Wrapped) {
  if (Wrapped.prototype instanceof _wordpress_element__WEBPACK_IMPORTED_MODULE_6__.Component) {
    return /*#__PURE__*/function (_Wrapped) {
      (0,_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__.default)(_class, _Wrapped);

      var _super = _createSuper(_class);

      function _class() {
        (0,_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, _class);

        return _super.apply(this, arguments);
      }

      (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(_class, [{
        key: "shouldComponentUpdate",
        value: function shouldComponentUpdate(nextProps, nextState) {
          return !(0,_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_7__.default)(nextProps, this.props) || !(0,_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_7__.default)(nextState, this.state);
        }
      }]);
  ...
  return /*#__PURE__*/function (_Component) {
    (0,_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__.default)(_class2, _Component);

    var _super2 = _createSuper(_class2);

    function _class2() {
      (0,_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, _class2);

      return _super2.apply(this, arguments);
    }

    (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(_class2, [{
      key: "shouldComponentUpdate",
      value: function shouldComponentUpdate(nextProps) {
        return !(0,_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_7__.default)(nextProps, this.props);
      }
    }, {
      key: "render",
      value: function render() {
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.createElement)(Wrapped, this.props);
      }
    }]);
...
function createHigherOrderComponent(mapComponentToEnhancedComponent, modifierName) {
  return function (OriginalComponent) {
    ...
    EnhancedComponent.displayName = "".concat((0,lodash__WEBPACK_IMPORTED_MODULE_0__.upperFirst)((0,lodash__WEBPACK_IMPORTED_MODULE_0__.camelCase)(modifierName)), "(").concat(displayName, ")");
...
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "./node_modules/@wordpress/element/node_modules/react/index.js");
/**
 * WordPress dependencies
 */

var Context = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)(false);
...
var Context = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)(_default_registry__WEBPACK_IMPORTED_MODULE_1__.default);
var Consumer = Context.Consumer,
    Provider = Context.Provider;
/**
...
/* harmony import */ var _wordpress_priority_queue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/priority-queue */ "./node_modules/@wordpress/priority-queue/build-module/index.js");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "./node_modules/@wordpress/element/node_modules/react/index.js");
...
var renderQueue = (0,_wordpress_priority_queue__WEBPACK_IMPORTED_MODULE_2__.createQueue)();
/**
...
function useSelect(_mapSelect, deps) {
  var mapSelect = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(_mapSelect, deps);
  var registry = (0,_registry_provider_use_registry__WEBPACK_IMPORTED_MODULE_3__.default)();
  var isAsync = (0,_async_mode_provider_use_async_mode__WEBPACK_IMPORTED_MODULE_4__.default)(); // React can sometimes clear the `useMemo` cache.
  // We use the cache-stable `useMemoOne` to avoid
  // losing queues.

  var queueContext = (0,use_memo_one__WEBPACK_IMPORTED_MODULE_5__.useMemoOne)(function () {
    return {
      queue: true
    };
  }, [registry]);

  var _useReducer = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useReducer)(function (s) {
    return s + 1;
  }, 0),
      _useReducer2 = (0,_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useReducer, 2),
      forceRender = _useReducer2[1];

  var latestMapSelect = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  var latestIsAsync = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(isAsync);
  var latestMapOutput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  var latestMapOutputError = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  var isMountedAndNotUnsubscribing = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(); // Keep track of the stores being selected in the mapSelect function,
  // and only subscribe to those stores later.

  var listeningStores = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)([]);
  var trapSelect = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (callback) {
  ...
  var depsChangedFlag = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
    return {};
  }, deps || []);
  var mapOutput;
    ...
    var onStoreChange = function onStoreChange() {
      if (isMountedAndNotUnsubscribing.current) {
        try {
          ...
          if ((0,_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_6__.default)(latestMapOutput.current, newMapOutput)) {
            return;
          }
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/element */ "./node_modules/@wordpress/element/node_modules/react/index.js");
...
var withSelect = function withSelect(mapSelectToProps) {
  return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.default)(function (WrappedComponent) {
    return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.default)(function (ownProps) {
      var mapSelect = function mapSelect(select, registry) {
        return mapSelectToProps(select, ownProps, registry);
      };

      var mergeProps = (0,_use_select__WEBPACK_IMPORTED_MODULE_3__.default)(mapSelect);
...
var builtinControls = (_builtinControls = {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_builtinControls, SELECT, (0,_factory__WEBPACK_IMPORTED_MODULE_2__.createRegistryControl)(function (registry) {
  return function (_ref) {
    ...
    var storeKey = _ref.storeKey,
        ...
        args = _ref.args;
    return (_registry$select = registry.select(storeKey))[selectorName].apply(_registry$select, (0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(args));
  };
})), (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_builtinControls, RESOLVE_SELECT, (0,_factory__WEBPACK_IMPORTED_MODULE_2__.createRegistryControl)(function (registry) {
  return function (_ref2) {
    ...
    return (_registry$method = registry[method](storeKey))[selectorName].apply(_registry$method, (0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(args));
  };
})), (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_builtinControls, DISPATCH, (0,_factory__WEBPACK_IMPORTED_MODULE_2__.createRegistryControl)(function (registry) {
  return function (_ref3) {
    ...
    var storeKey = _ref3.storeKey,
        ...
        args = _ref3.args;
    return (_registry$dispatch = registry.dispatch(storeKey))[actionName].apply(_registry$dispatch, (0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(args));
  };
})), _builtinControls);
...
/* harmony import */ var turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! turbo-combine-reducers */ "./node_modules/turbo-combine-reducers/index.js");
/* harmony import */ var turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var equivalent_key_map__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! equivalent-key-map */ "./node_modules/equivalent-key-map/equivalent-key-map.js");
/* harmony import */ var equivalent_key_map__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(equivalent_key_map__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @wordpress/redux-routine */ "./node_modules/@wordpress/redux-routine/build-module/index.js");
...
/* harmony import */ var _promise_middleware__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../promise-middleware */ "./node_modules/@wordpress/data/build-module/promise-middleware.js");
/* harmony import */ var _resolvers_cache_middleware__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../resolvers-cache-middleware */ "./node_modules/@wordpress/data/build-module/resolvers-cache-middleware.js");
/* harmony import */ var _metadata_reducer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./metadata/reducer */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/reducer.js");
/* harmony import */ var _metadata_selectors__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./metadata/selectors */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/selectors.js");
/* harmony import */ var _metadata_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./metadata/actions */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/actions.js");
...
function createResolversCache() {
  ...
  return {
    ...
    markAsRunning: function markAsRunning(selectorName, args) {
      if (!cache[selectorName]) {
        cache[selectorName] = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_5___default())();
      }
...
function createReduxStore(key, options) {
  return {
    ...
    instantiate: function instantiate(registry) {
      ...
      var resolvers;
      var actions = mapActions(_objectSpread(_objectSpread({}, _metadata_actions__WEBPACK_IMPORTED_MODULE_6__), options.actions), store);
      var selectors = mapSelectors(_objectSpread(_objectSpread({}, (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(_metadata_selectors__WEBPACK_IMPORTED_MODULE_7__, function (selector) {
      ...
      })), (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(options.selectors, function (selector) {
...
function instantiateReduxStore(key, options, registry) {
  ...
  var normalizedControls = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(controls, function (control) {
    return control.isRegistryControl ? control(registry) : control;
  });
  var middlewares = [(0,_resolvers_cache_middleware__WEBPACK_IMPORTED_MODULE_9__.default)(registry, key), _promise_middleware__WEBPACK_IMPORTED_MODULE_10__.default, (0,_wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_11__.default)(normalizedControls)];
  var enhancers = [redux__WEBPACK_IMPORTED_MODULE_12__.applyMiddleware.apply(void 0, middlewares)];
  ...
  var enhancedReducer = turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_4___default()({
    metadata: _metadata_reducer__WEBPACK_IMPORTED_MODULE_13__.default,
    root: reducer
  });
  return (0,redux__WEBPACK_IMPORTED_MODULE_12__.createStore)(enhancedReducer, {
    root: initialState
  }, (0,lodash__WEBPACK_IMPORTED_MODULE_3__.flowRight)(enhancers));
}
/**
...
function mapSelectors(selectors, store) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(selectors, createStateSelector);
}
/**
...
function mapActions(actions, store) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(actions, createBoundAction);
}
/**
...
function mapResolvers(resolvers, selectors, store, resolversCache) {
  ...
  var mappedResolvers = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(resolvers, function (resolver) {
    if (resolver.fulfill) {
      return resolver;
    }
  ...
  var mapSelector = function mapSelector(selector, selectorName) {
    ...
    var selectorResolver = function selectorResolver() {
      ...
      function _fulfillSelector() {
        _fulfillSelector = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  ...
                  if (!_metadata_selectors__WEBPACK_IMPORTED_MODULE_7__.hasStartedResolution(metadata, selectorName, args)) {
                    _context2.next = 6;
                    break;
                  }
                ...
                case 6:
                  ...
                  setTimeout( /*#__PURE__*/(0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
                    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            resolversCache.clear(selectorName, args);
                            store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_6__.startResolution(selectorName, args));
                            _context.next = 4;
                            return fulfillResolver.apply(void 0, [store, mappedResolvers, selectorName].concat(args));

                          case 4:
                            store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_6__.finishResolution(selectorName, args));
  ...
  return {
    ...
    selectors: (0,lodash__WEBPACK_IMPORTED_MODULE_3__.mapValues)(selectors, mapSelector)
  };
}
/**
...
function _fulfillResolver() {
  _fulfillResolver = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(store, resolvers, selectorName) {
    var resolver,
        _len4,
        args,
        _key4,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            resolver = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.get)(resolvers, [selectorName]);
...
var subKeysIsResolved = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.onSubKey)('selectorName')(function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())();
  ...
  switch (action.type) {
    ...
    case 'FINISH_RESOLUTION':
      {
        ...
        var nextState = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())(state);
    ...
    case 'INVALIDATE_RESOLUTION':
      {
        var _nextState = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())(state);
...
function getIsResolving(state, selectorName, args) {
  var map = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(state, [selectorName]);
...
var onSubKey = function onSubKey(actionProperty) {
  return function (reducer) {
    return function () {
      ...
      return _objectSpread(_objectSpread({}, state), {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)({}, key, nextKeyState));
    };
  };
};
...
/* harmony import */ var _redux_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./redux-store */ "./node_modules/@wordpress/data/build-module/redux-store/index.js");
...
function createRegistry() {
  ...
  var subscribe = function subscribe(listener) {
    ...
    return function () {
      listeners = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.without)(listeners, listener);
    };
  };
  /**
  ...
  function select(storeNameOrDefinition) {
    var storeName = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.isObject)(storeNameOrDefinition) ? storeNameOrDefinition.name : storeNameOrDefinition;
  ...
  var getResolveSelectors = memize__WEBPACK_IMPORTED_MODULE_3___default()(function (selectors) {
    return (0,lodash__WEBPACK_IMPORTED_MODULE_2__.mapValues)((0,lodash__WEBPACK_IMPORTED_MODULE_2__.omit)(selectors, ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'isResolving', 'getCachedResolvers']), function (selector, selectorName) {
      return function () {
  ...
  function withPlugins(attributes) {
    return (0,lodash__WEBPACK_IMPORTED_MODULE_2__.mapValues)(attributes, function (attribute, key) {
  ...
  registry.registerStore = function (storeName, options) {
    ...
    var store = (0,_redux_store__WEBPACK_IMPORTED_MODULE_4__.default)(storeName, options).instantiate(registry);
  ...
  registerGenericStore('core/data', (0,_store__WEBPACK_IMPORTED_MODULE_5__.default)(registry));
    ...
    return function (next) {
      return function (action) {
        ...
        Object.entries(resolvers).forEach(function (_ref) {
          ...
          var resolver = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.get)(registry.stores, [reducerKey, 'resolvers', selectorName]);
          ...
          resolversByArgs.forEach(function (value, args) {
            ...
            if (value !== false || !resolver.shouldInvalidate.apply(resolver, [action].concat((0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(args)))) {
              return;
  ...
  return {
    getSelectors: function getSelectors() {
      return ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'isResolving', 'getCachedResolvers'].reduce(function (memo, selectorName) {
        return _objectSpread(_objectSpread({}, memo), {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)({}, selectorName, getCoreDataSelector(selectorName)));
      }, {});
    },
    getActions: function getActions() {
      return ['startResolution', 'finishResolution', 'invalidateResolution', 'invalidateResolutionForStore', 'invalidateResolutionForStoreSelector'].reduce(function (memo, actionName) {
        return _objectSpread(_objectSpread({}, memo), {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)({}, actionName, getCoreDataAction(actionName)));
      }, {});
    },
...
/***/ "./node_modules/@wordpress/element/node_modules/react/cjs/react.development.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@wordpress/element/node_modules/react/cjs/react.development.js ***!
  \*************************************************************************************/
...
/***/ "./node_modules/@wordpress/element/node_modules/react/index.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@wordpress/element/node_modules/react/index.js ***!
  \*********************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./cjs/react.development.js */ "./node_modules/@wordpress/element/node_modules/react/cjs/react.development.js");
}
...
function createMiddleware() {
  ...
  return function (store) {
    var runtime = (0,_runtime__WEBPACK_IMPORTED_MODULE_0__.default)(controls, store.dispatch);
    return function (next) {
      return function (action) {
...
function createRuntime() {
  ...
  var rungenControls = (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(controls, function (control, actionType) {
  ...
  var rungenRuntime = (0,rungen__WEBPACK_IMPORTED_MODULE_0__.create)(rungenControls);
  return function (action) {
    return new Promise(function (resolve, reject) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "./node_modules/@wordpress/element/node_modules/react/index.js");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/data */ "./node_modules/@wordpress/data/build-module/components/with-select/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.default)(function (select, props) {
